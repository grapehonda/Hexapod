...
#define cRRTibiaMin1    -300      // Increased min to reduce inward curl
...
#define cRMTibiaMin1    -300      // Increased min to reduce inward curl
...
#define cRFTibiaMin1    -300      // Increased min to reduce inward curl
...
#define cLRTibiaMin1    -300      // Increased min to reduce inward curl
...
#define cLMTibiaMin1    -300      // Increased min to reduce inward curl
...
#define cLFTibiaMin1    -300      // Increased min to reduce inward curl
